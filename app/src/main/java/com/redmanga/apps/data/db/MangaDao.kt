...
interface MangaDao {
    ...
    @Query("SELECT * FROM Manga WHERE judul LIKE :search OR nama_kategori LIKE :search_kat ORDER BY id_manga DESC")
    fun getResManga(search: String = "%%", search_kat: String = "%%"): PositionalDataSource<Manga>
